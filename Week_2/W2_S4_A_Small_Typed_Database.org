...
let proof_of_bug =
  [| 
    {code = 0; contact = { name = "Rick"; phone_number = (1, 3, 5, 7) }};
    {code = 0; contact = { name = "Morty"; phone_number = (1, 1, 5, 7) }};
    {code = 1; contact = { name = "Rick"; phone_number = (1, 3, 5, 7) }};
    {code = 2; contact = { name = "Morty"; phone_number = (1, 1, 5, 7) }}
  |] ;;
...
let delete db contact =
  ...
  if not status then (false, db, contact)
    ...
    let rec cells i = 
      if i = db.number_of_contacts - 1 
      then nobody
      else if db.contacts.(i).name = contact.name 
      then db.contacts.(db.number_of_contacts -1)
